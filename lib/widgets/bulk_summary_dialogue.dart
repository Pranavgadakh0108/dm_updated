...
class BulkJodiBetSummaryDialog extends StatefulWidget {
  final String title;
  final String date;
  ...
  const BulkJodiBetSummaryDialog({
    super.key,
    required this.title,
    required this.date,
    required this.bids,
  ...
  @override
  State<BulkJodiBetSummaryDialog> createState() => _BulkJodiBetSummaryDialogState();
}

class _BulkJodiBetSummaryDialogState extends State<BulkJodiBetSummaryDialog> {
  @override
  void initState() {
    super.initState();
                  ...
                  child: ListView.builder(
                    ...
                    itemBuilder: (context, index) {
                      ...
                      return Padding(
                        ...
                        child: Row(
                          children: [
                            Expanded(child: Text(bid.keys.first)),
                            Expanded(child: Text(bid.values.first)),
                          ],
                        ),
                      );
                    },
