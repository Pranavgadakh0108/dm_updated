    ...
    return Consumer<UserProfileProvider>(
      builder: (context, provider, child) {
        ...
        final bool hasSufficientBalance =
            widget.totalBidAmount <= walletBalance;
                    ...
                    itemBuilder: (context, index) {
                      ...
                      return Padding(
                        ...
                        child: Row(
                          children: [
                            Expanded(
                              child: Text(bid['digit'] ?? bid['displayDigit']!),
                            ),
                ...
                Column(
                  ...
                  children: [
                    ...
                    if (hasSufficientBalance)
                      Text(
                        "After Bid: ${walletBalance - widget.totalBidAmount}",
                      ),
                    if (!hasSufficientBalance)
                      const Text(
                    ...
                    ElevatedButton(
                      style: ElevatedButton.styleFrom(
                        backgroundColor: hasSufficientBalance
                            ? Colors.orange
                            : Colors.grey,
                        foregroundColor: hasSufficientBalance
                            ? Colors.white
                            : Colors.black54,
                      ),
