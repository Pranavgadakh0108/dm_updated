...
class GameRateService {
  ...
  Future<GameRatesModel?> getGameRates() async {
    try {
      ...
      if (response.statusCode == 200) {
        ...
        final gameRateModel = GameRatesModel.fromJson(response.data);
        ...
        print(
          'Failed to fetch game rates. Status code: ${response.statusCode}',
        );
