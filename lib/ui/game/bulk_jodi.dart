...
//       if (userId != null) {
//         final provider = Provider.of<BulkJodiBetProvider>(
//           context,
//           listen: false,
//         );

//         provider.setGameId(widget.marketId); // Set your actual game ID
//         provider.setGameType("BULK_JODI"); // Set your actual game type
//         provider.setUserId(userId!); // Set your actual user ID
...
//   // void initState() {
//   //   super.initState();
//   //   // Initialize provider with default values if needed
...
//   //   provider.setGameId(widget.marketId); // Set your actual game ID
//   //   provider.setGameType("BULK_JODI"); // Set your actual game type
//   //   provider.setUserId("your_user_id_here"); // Set your actual user ID
//   //   provider.setGameDate(DateTime.now());
//   // }
...
//         create: (context) => BulkJodiBetProvider(),
//         child: Consumer<BulkJodiBetProvider>(
//           builder: (context, provider, child) {
