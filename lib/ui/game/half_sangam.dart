...
class _HalfSangamState extends State<HalfSangam> {
  ...
  // Dropdown methods for each field
  void _onOpenDigitsFocusChange() {
    if (_openDigitsFocusNode.hasFocus) {
      _showOpenDigitsDropdownOverlay();
    } else {
                          ...
                          child: Padding(
                            ...
                            child: GestureDetector(
                              onTap: () {
                                setState(() {
                                  _closeDigitsController.text = number.toString();
                                  _closeDigitsController.selection =
                                      TextSelection.fromPosition(
                                    TextPosition(
                                      offset: _closeDigitsController.text.length,
                                    ),
                            ...
                            children: [
                              if (!_isFlipped) ...[
                                ...
                                Row(
                                  ...
                                  children: [
                                    ...
                                    SizedBox(width: isSmallScreen ? screenWidth * 0.05 : screenWidth * 0.1),
                                    Expanded(
                                      child: CompositedTransformTarget(
                                        link: _openDigitsLayerLink,
                                        child: GestureDetector(
                                          ...
                                          child: CustomTextfieldScreen1(
                                            ...
                                            onChanged: (value) {
                                              if (value.length > 1) {
                                                ...
                                                _openDigitsController.selection = TextSelection.fromPosition(TextPosition(offset: 1));
                                              } else {
                                ...
                                Row(
                                  ...
                                  children: [
                                    ...
                                    SizedBox(width: isSmallScreen ? screenWidth * 0.04 : screenWidth * 0.09),
                                    Expanded(
                                      child: CompositedTransformTarget(
                                        link: _closePannaLayerLink,
                                        child: GestureDetector(
                                          ...
                                          child: CustomTextfieldScreen1(
                                            ...
                                            onChanged: (value) {
                                              if (value.length > 3) {
                                                ...
                                                _closePannaController.selection = TextSelection.fromPosition(TextPosition(offset: 3));
                                              } else {
                                          ...
                                          child: CustomTextfieldScreen1(
                                            ...
                                            onChanged: (value) {
                                              if (value.length > 3) {
                                                ...
                                                _openPannaController.selection = TextSelection.fromPosition(TextPosition(offset: 3));
                                              } else {
                                          ...
                                          child: CustomTextfieldScreen1(
                                            ...
                                            onChanged: (value) {
                                              if (value.length > 1) {
                                                ...
                                                _closeDigitsController.selection = TextSelection.fromPosition(TextPosition(offset: 1));
                                              } else {
                              ...
                              Row(
                                children: [
                                  ...
                                  SizedBox(width: isSmallScreen ? screenWidth * 0.15 : screenWidth * 0.2),
                                  Expanded(
                                    child: CustomTextfieldScreen1(
                                      controller: _pointsController,
                                      hintText: "Enter Points",
                                      ...
                                      validator: (value) {
                                        if (value == null || value.isEmpty || int.parse(value) < 10 || int.parse(value) > 1000) {
                                          return "Enter amount \nbetween 10 - 1000";
                                        }
                                        return null;
                                      },
