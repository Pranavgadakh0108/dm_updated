    ...
    return Scaffold(
      ...
      body: Consumer<HowToPlayProvider>(
        builder: (context, provider, child) {
          ...
          if (!provider.isLoading && !provider.hasData && provider.errorMessage == null) {
          ...
          // Create items list from the provider data
          final List<Map<String, String>> items = [
            {
              'title': 'How to Play',
              'url': provider.howToPlay,
            },
            {
              'title': 'How to Deposit',
              'url': provider.howToDeposit,
            },
            {
              'title': 'How to Withdraw',
              'url': provider.howToWithdraw,
            },
          ];
