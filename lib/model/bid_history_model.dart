...
class BidHistoryModel {
  ...
  factory BidHistoryModel.fromJson(Map<String, dynamic> json) =>
      BidHistoryModel(
        success: (json["success"] as num).toInt(), // Convert to int
...
class Bet {
  ...
  factory Bet.fromJson(Map<String, dynamic> json) => Bet(
    ...
    number: json["number"],
    amount: (json["amount"] as num).toInt(), // Convert to int
    market: json["market"],
    date: json["date"],
...
class Pagination {
  ...
  factory Pagination.fromJson(Map<String, dynamic> json) => Pagination(
    page: (json["page"] as num).toInt(), // Convert to int
    limit: (json["limit"] as num).toInt(), // Convert to int
    total: (json["total"] as num).toInt(), // Convert to int
    pages: (json["pages"] as num).toInt(), // Convert to int
  );
