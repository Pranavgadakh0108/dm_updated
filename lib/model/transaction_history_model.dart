...
class TransactionHistoryModel {
  ...
  factory TransactionHistoryModel.fromJson(Map<String?, dynamic>? json) =>
      TransactionHistoryModel(
        success:
            (json?["success"] as num?)?.toInt() ??
            0, // Handle double to int conversion
...
class Pagination {
  ...
  factory Pagination.fromJson(Map<String?, dynamic>? json) => Pagination(
    page: (json?["page"] as num?)?.toInt() ?? 0, // Handle double to int
    limit: (json?["limit"] as num?)?.toInt() ?? 0, // Handle double to int
    total: (json?["total"] as num?)?.toInt() ?? 0, // Handle double to int
    pages: (json?["pages"] as num?)?.toInt() ?? 0, // Handle double to int
  );
...
class Transaction {
  ...
  factory Transaction.fromJson(Map<String?, dynamic>? json) => Transaction(
    ...
    amount: (json?["amount"] as num?)?.toInt() ?? 0, // Handle double to int
    ...
    gameType: json?["gameType"] != null
        ...
        : null,
    number: json?["number"],
    market: json?["market"] != null ? marketValues.map[json?["market"]] : null,
  ...
  Map<String?, dynamic>? toJson() => {
    ...
    "number": number,
    "market": market != null ? marketValues.reverse[market] : null,
