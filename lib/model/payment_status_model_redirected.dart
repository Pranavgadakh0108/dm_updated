...
// //
// //     final paymentStatusModelRedirected = paymentStatusModelRedirectedFromJson(jsonString);
...
class PaymentStatusModelRedirectedRaw {
  String status;
  String? utr; // Made nullable
  RawRaw raw;

  PaymentStatusModelRedirectedRaw({
    required this.status,
    this.utr, // Now nullable
    required this.raw,
  });
